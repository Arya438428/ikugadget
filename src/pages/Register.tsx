...
import { Smartphone, Users, Star, Bell, Eye, EyeOff } from "lucide-react";
        ...
        <div className="relative z-10 space-y-6">
          <div className="space-y-3">
            <h1 className="text-4xl font-bold text-white leading-tight">
              Bergabung &<br />
              Mulai <span className="text-primary">Catat</span><br />
              Penjualanmu
            </h1>
            <p className="text-slate-400 text-base leading-relaxed max-w-sm">
              Daftarkan diri dan mulai kelola jurnal penjualan harianmu secara digital — cepat, rapi, dan akurat.
            </p>
          </div>

          <div className="space-y-3">
            {[
              { icon: Users, text: "Multi-akun seller & admin" },
              { icon: Star, text: "Sistem insentif & bonus otomatis" },
              { icon: Bell, text: "Notifikasi performa real-time" },
            ].map(({ icon: Icon, text }) => (
      ...
      <div className="flex w-full lg:w-1/2 flex-col items-center justify-center bg-background px-6 py-12">
        ...
        <div className="w-full max-w-sm space-y-8">
          <div className="space-y-1">
            ...
            <p className="text-sm text-muted-foreground">Gratis & langsung aktif setelah daftar</p>
          </div>
